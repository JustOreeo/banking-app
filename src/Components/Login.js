...
export default function Login({Userlist}) {
    ...
    function handleLogin(e){
      ...
      function addUser(){
        ...
        console.log(storedUsers)
        if(storedUsers){
          storedUsers.push({id:2, name:"Test User",email:"user@gmail.com",password:"01234567",accountType:"user",balance:0})
  ...
  return (
    <div className='container'>
      ...
      <form onSubmit={handleLogin} className='container' noValidate> 
        <input type="email" ref={emailRef} /*value="admin@gmail.com"*/ placeholder='Email' className="input" onChange={handleEmail}/>
        <span className="errorMsg">{emailError}</span>
        <input type="password" ref={passRef} /*value="01234567"*/ placeholder='Password' className="input" onChange={handlePass}/>
      ...
      <button onClick={addUser}>Add one user for testing</button><br></br>
      <button onClick={delUser}>Delete storedUsers</button><br></br>
    </div>
  )
}
